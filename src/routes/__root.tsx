...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "RefundRight — Fight back against unfair travel charges" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "RefundRight — Don't let them keep your money" },
      {
        ...
        content:
          "AI-powered legal assistant for travel disputes, flight delays, and hotel deposit issues across Southeast Asia.",
      },
